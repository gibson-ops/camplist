 ...
 * traveled a whole window height for a sheet a third that size, and a dismiss threshold in the
 * wrong units by a factor of a thousand. Every one of those is a behavior the operating system
 ...
 * behavior, but because it was the one platform that got the surface WRONG: `@expo/ui` hardcodes
