...
def main():
    ...
    def lockup(theme, text_fill, bg=None):
        ...
        k = ascender / chh
        stack_w = cw * k
        # Centered on the word's own vertical extent rather than sat on the
    ...
    # Themed icons flatten this to one color, so the mark is drawn in a single
    ...
    ts = ("// GENERATED by brand/generator/build.py. Do not edit by hand.\n"
          ...
          "// matches brand/camplist-wordmark.svg exactly. Colors are substituted by the\n"
